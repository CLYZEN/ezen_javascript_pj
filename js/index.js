    ...
    success: function (data) {
      ...
      for (const result of results) {
        ...
        $(".populer_poster").append(
          `<swiper-slide><a href="./detail.html?id=${movieId}" target="_blank"><img src="https://image.tmdb.org/t/p/w500${poster_path}" alt="populer_poster" class="poster_img"></a></swiper-slide>`
        )
    ...
    success: function (data) {
      ...
      for (const result of results) {
        ...
        $(".nowplaying_poster").append(
          `<swiper-slide><a href="./detail.html?id=${movieId}" target="_blank"><img src="https://image.tmdb.org/t/p/w500${poster_path}" alt="now_playing_poster" class="poster_img"></a></swiper-slide>`
        )
      }
    },
    error: function (request, status, error) {
    ...
    success: function (data) {
      ...
      for (const result of results) {
        ...
        $(".toprated_poster").append(
          `<swiper-slide><a href="./detail.html?id=${movieId}" target="_blank"><img src="https://image.tmdb.org/t/p/w500${poster_path}" alt="toprated_poster" class="poster_img"></a></swiper-slide>`
        )
      }
    },
    error: function (request, status, error) {
    ...
    success: function (data) {
      ...
      for (const result of results) {
        ...
        $(".upcoming_poster").append(
          `<swiper-slide><a href="./detail.html?id=${movieId}" target="_blank"><img src="https://image.tmdb.org/t/p/w500${poster_path}" alt="upcoming_poster" class="poster_img"></a></swiper-slide>`
        )
      }
    },
    error: function (request, status, error) {
